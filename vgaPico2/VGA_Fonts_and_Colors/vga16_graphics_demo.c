...
static PT_THREAD (protothread_graphics(struct pt *pt)) {
    ...
    static short circle_x = 200, circle_color = 11 ; 
    ...
    fillRect(14, 0, 220, 50, RED); // blue box
    ...
    setCursor(15, 0) ;
    setTextSize(1) ;
    writeString("Raspberry Pi Pico1 pdsilva(09-2025)") ;
    setCursor(15, 10) ;
    ...
    uint8_t pix_color = 0;//readPixel(320,100) ;
